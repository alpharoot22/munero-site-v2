  ...
  return (
    <div style={{ background: "#10101A", border: "0.5px solid #1E1E2E", borderRadius: 14, padding: 16 }}>
      <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", marginBottom: 4 }}>
        ...
        <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 10, color: "#1D9E75" }}>+18%</span>
      </div>
      <div style={{ fontFamily: "var(--font-inter), sans-serif", fontSize: 26, color: "#E8E8F0", fontWeight: 500, letterSpacing: "-0.02em", lineHeight: 1, marginBottom: 4 }}>
        4.62x
      </div>
      <div style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9.5, color: "#505068", marginBottom: 8 }}>
        vs last 7 days
      </div>
      <svg width="100%" height="34" viewBox="0 0 160 34" preserveAspectRatio="none">
        ...
        <path d="M0,28 L20,26 L40,22 L60,24 L80,18 L100,14 L120,10 L140,7 L160,3 L160,34 L0,34 Z" fill="url(#roas-area)" />
        <path d="M0,28 L20,26 L40,22 L60,24 L80,18 L100,14 L120,10 L140,7 L160,3" stroke="#3B82F6" strokeWidth="1.5" fill="none" />
      </svg>
    </div>
  );
}
